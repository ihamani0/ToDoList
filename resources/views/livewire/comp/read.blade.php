<div id="todos-list">
    ...
    <div wire:key="{{$todo->id}}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
            ...
            <div class="flex justify-between space-x-2 ">
                ...
                @if( $editeNewID == $todo->id)
                     <input wire:model="editeNewName" type="text" placeholder="Todo.."
                ...
                @else
                    ...
                    <div class="flex justify-content-center align-items-center">
                        @if($todo->status)
                            <input wire:click="Checked({{$todo->id}})" type="checkbox" class="mr-3" checked>
                        @else
                            <input wire:click="Checked({{$todo->id}})" type="checkbox" class="mr-3">
                        @endif
                    ...
                    <div class="flex items-center space-x-2">
                        <button   wire:click="Edite({{$todo->id}})" class="text-sm text-teal-500 font-semibold rounded hover:text-teal-800">
            ...
            <span class="text-xs text-gray-500"> {{$todo->created_at->format('Y/m/d H-i')}}</span>
